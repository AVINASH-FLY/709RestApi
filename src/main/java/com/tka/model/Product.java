...
public class Product {
	...
	@Pattern(regexp = "^\\d{4}-\\d{2}-\\d{2}$", message = "mfgDate should be in the format yyyy-MM-dd")
    private String mfgDate;
	
	@Pattern(regexp = "^\\d{4}-\\d{2}-\\d{2}$", message = "expDate should be in the format yyyy-MM-dd")
